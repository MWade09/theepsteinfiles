import { FinancialEntity } from '@/types/investigation';
...
export const financialEntities: FinancialEntity[] = [
  ...
  // Additional entities identified by validation
  {
    id: 'entity_epstein_foundation',
    name: 'Jeffrey Epstein Foundation',
    type: 'foundation',
    registrationCountry: 'United States',
    registrationState: 'Virgin Islands',
    parentCompany: undefined,
    subsidiaries: [],
    controllers: ['entity_epstein_individual'],
    ...
    description: 'Epstein\'s charitable foundation used for tax benefits and money laundering',
    establishedDate: '1996-01-01',
    dissolutionDate: '2019-08-10',
    currentStatus: 'dissolved',
    addresses: [],
    ...
    suspiciousActivity: [],
    sources: [],
    tags: ['foundation', 'charity', 'tax-haven'],
    lastUpdated: '2024-01-15'
  },

  {
    id: 'entity_previous_owner_lsj',
    name: 'Little Saint James Previous Owner',
    type: 'individual',
    registrationCountry: 'United States',
    registrationState: 'Virgin Islands',
    parentCompany: undefined,
    ...
    description: 'Previous owner of Little Saint James island before Epstein\'s purchase',
    ...
    suspiciousActivity: [],
    sources: [],
    tags: ['real-estate', 'virgin-islands'],
    lastUpdated: '2024-01-15'
  },

  {
    id: 'entity_kirkland_ellis',
    ...
    description: 'Major law firm involved in Epstein legal matters',
    establishedDate: '1908-01-01',
    dissolutionDate: undefined,
    currentStatus: 'active',
    addresses: [],
    relatedPersons: ['dershowitz_alan'],
    suspiciousActivity: [],
    sources: [],
    tags: ['law-firm', 'legal-services'],
    lastUpdated: '2024-01-15'
  },

  {
    id: 'entity_victim_settlement_fund',
    name: 'Epstein Victim Settlement Fund',
    type: 'trust',
    registrationCountry: 'United States',
    registrationState: 'New York',
    parentCompany: undefined,
    ...
    taxHaven: false,
    publiclyTraded: false,
    industry: 'Victim Compensation',
    description: 'Settlement fund for Epstein victims established after his death',
    ...
    suspiciousActivity: [],
    sources: [],
    tags: ['victim-compensation', 'settlement'],
    lastUpdated: '2024-01-15'
  },

  {
    ...
    description: 'Auction house where Epstein purchased and sold high-value art',
    establishedDate: '1744-01-01',
    dissolutionDate: undefined,
    currentStatus: 'active',
    addresses: [],
    relatedPersons: [],
    suspiciousActivity: [],
    sources: [],
    tags: ['auction-house', 'art-market'],
    lastUpdated: '2024-01-15'
  },

  {
    id: 'entity_modeling_agencies',
    name: 'Epstein-Connected Modeling Agencies',
    type: 'corporation',
    registrationCountry: 'Multiple',
    registrationState: 'Multiple',
    parentCompany: undefined,
    subsidiaries: [],
    controllers: [],
    legalStructure: 'corporation',
    taxHaven: false,
    publiclyTraded: false,
    industry: 'Modeling and Talent',
    description: 'Various modeling agencies connected to Epstein\'s trafficking network',
    establishedDate: '1990-01-01',
    dissolutionDate: undefined,
    currentStatus: 'active',
    addresses: [],
    relatedPersons: ['brunel_jean_luc'],
    suspiciousActivity: [],
    sources: [],
    tags: ['modeling', 'trafficking-network'],
    lastUpdated: '2024-01-15'
  },

  {
    id: 'entity_harvard_university',
    ...
    publiclyTraded: false,
    industry: 'Education',
    description: 'Prestigious university that received donations from Epstein',
    establishedDate: '1636-01-01',
    dissolutionDate: undefined,
    currentStatus: 'active',
    addresses: [],
    relatedPersons: [],
    suspiciousActivity: [],
    sources: [],
    tags: ['university', 'education', 'donations'],
    lastUpdated: '2024-01-15'
  },

  {
    id: 'entity_mit_media_lab',
    name: 'MIT Media Lab',
    type: 'other',
    registrationCountry: 'United States',
    registrationState: 'Massachusetts',
    ...
    description: 'MIT research lab that received funding from Epstein',
    establishedDate: '1985-01-01',
    dissolutionDate: undefined,
    currentStatus: 'active',
    addresses: [],
    relatedPersons: ['ito_joi'],
    suspiciousActivity: [],
    sources: [],
    tags: ['research', 'mit', 'funding'],
    lastUpdated: '2024-01-15'
  },

  {
    id: 'entity_construction_companies',
    name: 'Epstein Construction Contractors',
    type: 'corporation',
    registrationCountry: 'United States',
    registrationState: 'Multiple',
    parentCompany: undefined,
    ...
    description: 'Construction companies hired for Epstein property developments',
    establishedDate: '1990-01-01',
    dissolutionDate: undefined,
    currentStatus: 'active',
    addresses: [],
    ...
    suspiciousActivity: [],
    sources: [],
    tags: ['construction', 'property-development'],
    lastUpdated: '2024-01-15'
  },

  {
    id: 'entity_legal_defense_fund',
    name: 'Epstein Legal Defense Fund',
    type: 'trust',
    registrationCountry: 'United States',
    registrationState: 'New York',
    parentCompany: undefined,
    ...
    description: 'Fund established to cover Epstein\'s legal defense costs',
